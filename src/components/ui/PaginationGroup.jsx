...
function PaginationGroup({ pageInfo, searchParamKey = 'page' }) {
    ...
    return (
        <Pagination>
            <PaginationContent>
                <PaginationItem>
                    <PaginationPrevious disabled={currPage - 1 === 0} onClick={() => handleClick(currPage - 1)} />
                </PaginationItem>
                {currPage - 1 >= 3 && (
                    <>
                        <PaginationItem>
                    ...
                    (p) =>
                        ...
                        p <= totalPages && (
                            <PaginationItem key={p}>
                                <PaginationLink isActive={currPage === p} onClick={() => handleClick(p)}>
                                    {p}
                                </PaginationLink>
                            </PaginationItem>
                        ),
                ...
                {totalPages - currPage >= 3 && (
                    <>
                        ...
                        <PaginationItem>
                            <PaginationLink isActive={false} onClick={() => handleClick(totalPages)}>
                                {totalPages}
                            </PaginationLink>
                        </PaginationItem>
                    </>
                ...
                <PaginationItem>
                    <PaginationNext disabled={currPage + 1 > totalPages} onClick={() => handleClick(currPage + 1)} />
                </PaginationItem>
            </PaginationContent>
        </Pagination>
    );
